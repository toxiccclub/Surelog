...
class ErrorDefinition {
 public:
  ...
  enum ErrorType {
    ...
    LINT_DPI_DECLARATION_STRING = 735,
    LINT_HIERARCHICAL_INTERFACE_IDENTIFIER = 736,
    LINT_IMPLICIT_DATA_TYPE = 737,
    LINT_PARAMETR_DYNAMIC_ARRAY = 738,
    LINT_PROTOTYPE_RETURN_DATA_TYPE = 739,
    LINT_REPETITION_IN_SEQUENCE = 740,
    LINT_FATAL_SYSCALL = 741
  };
